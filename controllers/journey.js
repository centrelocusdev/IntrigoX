...
const {Chapter , Paragraph, Question , ObstacleQuestion} = require('../models/chapter');
const {chapterData , ParagraphsData, Question1Data, Question2Data , ObstacleQuestionsData} = require('../data');
...
exports.getChaptersData = async(req, res)=> {
  try{
    ...
    const newChapter = util.inspect(getChapter, { depth: null, compact: false, colors: true });
